...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        # default=None,
        default=["Generate a depth map from a building floor plan."],
        nargs="+",
        help=(
    ...
    parser.add_argument(
        ...
        # default=None,
        default=[
            "/ssd/du_dataset/mvdfusion/my_dataset_processed_blender_whiteblock_512_num1_angle90_floor_plan/159_contour.png",
            "/ssd/du_dataset/mvdfusion/my_dataset_processed_blender_whiteblock_512_num1_angle90_floor_plan/004_contour.png"
        ],
        nargs="+",
        help=(
